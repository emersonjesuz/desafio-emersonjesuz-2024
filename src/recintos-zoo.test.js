...
describe("Recintos do Zoologico", () => {
  test("Deve rejeitar se o animal não for informado", () => {
  ...
  test("Deve rejeitar se a quantidade for diferente de um numero", () => {
  ...
  test("deve rejeitar recinto para adicionar 3 hipopotamas", () => {
    const resultado = new RecintosZoo().analisaRecintos("HIPOPOTAMO", 3);
    expect(resultado.erro).toBe("Não há recinto viável");
    expect(resultado.recintosViaveis).toBeFalsy();
  });

  test("Deve encontrar 1 recintos para 2 hipopotamas", () => {
  ...
  test("Deve encontrar 1 recinto para 1 leaopardo", () => {
